 ...
 *
 *    Keep the ElementsPicsounium object in this class and all calls to this object
...
public class Picsounium {
	...
	public static final String VERSION = "0.8.8.2";
	...
	@Mod.Instance(MODID)
	public static Picsounium instance;
	public ElementsPicsounium elements = new ElementsPicsounium();
	@Mod.EventHandler
	public void preInit(FMLPreInitializationEvent event) {
		MinecraftForge.EVENT_BUS.register(this);
		GameRegistry.registerWorldGenerator(elements, 5);
		GameRegistry.registerFuelHandler(elements);
		NetworkRegistry.INSTANCE.registerGuiHandler(this, new ElementsPicsounium.GuiHandler());
