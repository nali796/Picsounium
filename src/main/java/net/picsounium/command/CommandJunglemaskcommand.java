...
import net.picsounium.procedure.ProcedureJungle_mask_give;
...
public class CommandJunglemaskcommand extends ElementsPicsounium.ModElement {
	...
	public static class CommandHandler implements ICommand {
		...
		public String getName() {
			return "36bh2rn86nt8hpka7maz";
		}

		@Override
		public String getUsage(ICommandSender var1) {
			return "/36bh2rn86nt8hpka7maz [<arguments>]";
		}
		...
		public void execute(MinecraftServer server, ICommandSender sender, String[] cmd) {
			...
			if (entity != null) {
				...
				});
				{
					...
					ProcedureJungle_mask_give.executeProcedure($_dependencies);
				}
			}
		}
	}
