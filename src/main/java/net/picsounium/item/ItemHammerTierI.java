...
public class ItemHammerTierI extends ElementsPicsounium.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemPickaxe(EnumHelper.addToolMaterial("HAMMERTIERI", 3, 435, 6f, 0f, 2)) {
			{
				this.attackSpeed = -3f;
			}
		...
		}.setUnlocalizedName("hammertieri").setRegistryName("hammertieri").setCreativeTab(TabPicsouniumtab.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("picsounium:hammertieri", "inventory"));
	}
}
