...
public class ItemOriumShovel extends ElementsPicsounium.ModElement {
	...
	public void initElements() {
		elements.items.add(() -> new ItemSpade(EnumHelper.addToolMaterial("ORIUMSHOVEL", 7, 1330, 12f, 3.9f, 46)) {
			{
				this.attackSpeed = -3f;
			}
		...
		}.setUnlocalizedName("oriumshovel").setRegistryName("oriumshovel").setCreativeTab(TabPicsouniumtab.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("picsounium:oriumshovel", "inventory"));
	}
}
