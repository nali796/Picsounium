...
public class ItemLight extends ElementsPicsounium.ModElement {
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("picsounium:light", "inventory"));
	}
