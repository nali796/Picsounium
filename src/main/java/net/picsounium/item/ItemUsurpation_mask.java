...
public class ItemUsurpation_mask extends ElementsPicsounium.ModElement {
	@GameRegistry.ObjectHolder("picsounium:usurpation_maskhelmet")
	public static final Item helmet = null;
	@GameRegistry.ObjectHolder("picsounium:usurpation_maskbody")
	public static final Item body = null;
	@GameRegistry.ObjectHolder("picsounium:usurpation_masklegs")
	...
	public void initElements() {
		ItemArmor.ArmorMaterial enuma = EnumHelper.addArmorMaterial("USURPATION_MASK", "picsounium:atricium__", 25, new int[]{2, 5, 6, 2}, 9,
		...
		elements.items.add(() -> new ItemArmor(enuma, 0, EntityEquipmentSlot.HEAD) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EntityEquipmentSlot slot, String type) {
				return "picsounium:textures/usurpation_mask.png";
			}
		...
		}.setUnlocalizedName("usurpation_maskhelmet").setRegistryName("usurpation_maskhelmet").setCreativeTab(null));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(helmet, 0, new ModelResourceLocation("picsounium:usurpation_maskhelmet", "inventory"));
	}
