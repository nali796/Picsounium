...
public class ItemLoupopo_hat extends ElementsPicsounium.ModElement {
	@GameRegistry.ObjectHolder("picsounium:loupopo_hathelmet")
	public static final Item helmet = null;
	@GameRegistry.ObjectHolder("picsounium:loupopo_hatbody")
	public static final Item body = null;
	@GameRegistry.ObjectHolder("picsounium:loupopo_hatlegs")
	...
	public void initElements() {
		ItemArmor.ArmorMaterial enuma = EnumHelper.addArmorMaterial("LOUPOPO_HAT", "picsounium:alloween_hat_", 0, new int[]{2, 5, 6, 2}, 9,
		...
		}.setUnlocalizedName("loupopo_hathelmet").setRegistryName("loupopo_hathelmet").setCreativeTab(null));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(helmet, 0, new ModelResourceLocation("picsounium:loupopo_hathelmet", "inventory"));
	}
