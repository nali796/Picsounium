...
import net.picsounium.procedure.ProcedureFakeWaterMobplayerCollidesBlock;
...
public class BlockFakeWater extends ElementsPicsounium.ModElement {
	@GameRegistry.ObjectHolder("picsounium:fakewater")
	...
	public void registerModels(ModelRegistryEvent event) {
		...
		ModelLoader.setCustomMeshDefinition(item, new ItemMeshDefinition() {
			...
			public ModelResourceLocation getModelLocation(ItemStack stack) {
				return new ModelResourceLocation("picsounium:fakewater", "fakewater");
			}
		});
