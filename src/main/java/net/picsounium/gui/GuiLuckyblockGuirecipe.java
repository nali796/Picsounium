...
import net.picsounium.procedure.ProcedureLuckyblockprocess;
...
public class GuiLuckyblockGuirecipe extends ElementsPicsounium.ModElement {
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("picsounium:textures/luckyblockguirecipe.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 58, this.guiTop + 32, 60, 20, "Lancer"));
		}
		...
		if (buttonID == 0) {
			{
				...
				ProcedureLuckyblockprocess.executeProcedure($_dependencies);
			}
		}
	}
